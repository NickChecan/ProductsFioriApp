sap.ui.define([
	"sap/ui/test/Opa5",
	"jd/poc/product/app/ProductApp/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("jd.poc.product.app.ProductApp.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "jd.poc.product.app.ProductApp",
					async: true
				},
				hash: oOptions.hash,
