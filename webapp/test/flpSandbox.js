		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo Product Application",
									"targetURL": "#DemoProductApplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DemoProductApplication-display": {
								"semanticObject": "DemoProductApplication",
								"action": "display",
								"description": "Demo Project Application for PoC scenario",
								"title": "Demo Product Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jd.poc.product.app.ProductApp",
									"url": sap.ui.require.toUrl("jd/poc/product/app/ProductApp")
								}
							}
						}
					}
